                ...
                <div class="block_body clearfix">
                    ...
                    <!--{else}-->
                        <ul class="formlist clearfix">
                            ...
                            <li class="forgot">
                                <a href="<!--{$smarty.const.HTTPS_URL}-->forgot/<!--{$smarty.const.DIR_INDEX_PATH}-->" onclick="eccube.openWindow('<!--{$smarty.const.HTTPS_URL}-->forgot/<!--{$smarty.const.DIR_INDEX_PATH}-->','forget','600','400',{scrollbars:'no',resizable:'no'}); return false;" target="_blank">パスワードがわからない方</a>
                            </li>
                        </ul>
                    <!--{/if}-->
                </div>
